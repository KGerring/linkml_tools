...
def identity_json(blob, *, cls=None, cypher=hashlib.blake2b, encoding='utf-8', sort_lists=False):
...
def scigraph_build(zip_location, git_remote, org, git_local, branch, commit, clean=False, check_built=False, cleanup_later=False, quiet=False):
