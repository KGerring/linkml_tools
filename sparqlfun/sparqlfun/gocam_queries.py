...
class ModelQuery(YAMLRoot):
    ...
    results: Optional[Union[Union[str, ModelId], List[Union[str, ModelId]]]] = (
        empty_list()
    )
    state: Optional[Union[str, "ModelStateEnum"]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.results = [
            v if isinstance(v, ModelId) else ModelId(v) for v in self.results
        ]
        ...
        if not isinstance(self.contributor, list):
            self.contributor = (
                [self.contributor] if self.contributor is not None else []
            )
        self.contributor = [
            v if isinstance(v, str) else str(v) for v in self.contributor
        ]
...
class Model(Entity):
    ...
    state: Optional[Union[str, "ModelStateEnum"]] = None
    provided_by: Optional[str] = None
    molecular_activity_set: Optional[
        Union[
            Dict[Union[str, MolecularActivityId], Union[dict, "MolecularActivity"]],
            List[Union[dict, "MolecularActivity"]],
        ]
    ] = empty_dict()
    biological_process_set: Optional[
        Union[
            Dict[Union[str, BiologicalProcessId], Union[dict, "BiologicalProcess"]],
            List[Union[dict, "BiologicalProcess"]],
        ]
    ] = empty_dict()
    information_biomacromolecule_set: Optional[
        Union[
            Dict[
                Union[str, InformationBiomacromoleculeId],
                Union[dict, "InformationBiomacromolecule"],
            ],
            List[Union[dict, "InformationBiomacromolecule"]],
        ]
    ] = empty_dict()
    chemical_entity_set: Optional[
        Union[
            Dict[Union[str, ChemicalEntityId], Union[dict, "ChemicalEntity"]],
            List[Union[dict, "ChemicalEntity"]],
        ]
    ] = empty_dict()
    ontology_class_set: Optional[
        Union[
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="molecular_activity_set",
            slot_type=MolecularActivity,
            key_name="id",
            keyed=True,
        )

        self._normalize_inlined_as_dict(
            slot_name="biological_process_set",
            slot_type=BiologicalProcess,
            key_name="id",
            keyed=True,
        )

        self._normalize_inlined_as_dict(
            slot_name="information_biomacromolecule_set",
            slot_type=InformationBiomacromolecule,
            key_name="id",
            keyed=True,
        )

        self._normalize_inlined_as_dict(
            slot_name="chemical_entity_set",
...
class DomainEntity(Entity):
    ...
    type: Union[str, OntologyClassId] = None
    type_inferences: Optional[
        Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.type_inferences, list):
            self.type_inferences = (
                [self.type_inferences] if self.type_inferences is not None else []
            )
        self.type_inferences = [
            v if isinstance(v, OntologyClassId) else OntologyClassId(v)
            for v in self.type_inferences
        ]
...
class MolecularActivity(DomainEntity):
    ...
    type: Union[str, OntologyClassId] = None
    has_activity_causal_associations: Optional[
        Union[
            Union[dict, "ActivityToActivityCausalAssociation"],
            List[Union[dict, "ActivityToActivityCausalAssociation"]],
        ]
    ] = empty_list()
    has_process_causal_associations: Optional[
        Union[
            Union[dict, "ActivityToProcessCausalAssociation"],
            List[Union[dict, "ActivityToProcessCausalAssociation"]],
        ]
    ] = empty_list()
    happens_during: Optional[
        Union[
            Union[dict, "HappensDuringAssociation"],
            List[Union[dict, "HappensDuringAssociation"]],
        ]
    ] = empty_list()
    part_of: Optional[
        Union[
            Union[dict, "ProcessPartOfAssociation"],
            List[Union[dict, "ProcessPartOfAssociation"]],
        ]
    ] = empty_list()
    enabled_by: Optional[
        Union[
            Union[dict, "EnabledByAssociation"],
            List[Union[dict, "EnabledByAssociation"]],
        ]
    ] = empty_list()
    has_input: Optional[
        Union[
            Union[dict, "HasInputAssociation"], List[Union[dict, "HasInputAssociation"]]
        ]
    ] = empty_list()
    occurs_in: Optional[
        Union[
            Union[dict, "OccursInAssociation"], List[Union[dict, "OccursInAssociation"]]
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_list(
            slot_name="has_activity_causal_associations",
            slot_type=ActivityToActivityCausalAssociation,
            key_name="object",
            keyed=False,
        )

        self._normalize_inlined_as_list(
            slot_name="has_process_causal_associations",
            slot_type=ActivityToProcessCausalAssociation,
            key_name="object",
            keyed=False,
        )

        self._normalize_inlined_as_list(
            slot_name="happens_during",
            slot_type=HappensDuringAssociation,
            key_name="object",
            keyed=False,
        )
        ...
        self._normalize_inlined_as_list(
            slot_name="part_of",
            slot_type=ProcessPartOfAssociation,
            key_name="object",
            keyed=False,
        )

        self._normalize_inlined_as_list(
            slot_name="enabled_by",
            slot_type=EnabledByAssociation,
            key_name="object",
            keyed=False,
        )
...
class BiologicalProcess(DomainEntity):
    ...
    has_activity_causal_associations: Optional[
        Union[
            Union[dict, "ProcessToActivityCausalAssociation"],
            List[Union[dict, "ProcessToActivityCausalAssociation"]],
        ]
    ] = empty_list()
    has_process_causal_associations: Optional[
        Union[
            Union[dict, "ProcessToProcessCausalAssociation"],
            List[Union[dict, "ProcessToProcessCausalAssociation"]],
        ]
    ] = empty_list()
    happens_during: Optional[
        Union[
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_list(
            slot_name="has_activity_causal_associations",
            slot_type=ProcessToActivityCausalAssociation,
            key_name="object",
            keyed=False,
        )
        ...
        self._normalize_inlined_as_list(
            slot_name="has_process_causal_associations",
            slot_type=ProcessToProcessCausalAssociation,
            key_name="object",
            keyed=False,
        )
...
class AnatomicalEntity(DomainEntity):
    ...
    part_of: Optional[
        Union[
            Union[dict, "AnatomicalPartOfAssociation"],
            List[Union[dict, "AnatomicalPartOfAssociation"]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_list(
            slot_name="part_of",
            slot_type=AnatomicalPartOfAssociation,
            key_name="object",
            keyed=False,
        )
...
class InformationBiomacromolecule(ChemicalEntity):
    ...
    has_part: Optional[
        Union[
            Union[dict, "MacromoleculeHasPartAssociation"],
            List[Union[dict, "MacromoleculeHasPartAssociation"]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_list(
            slot_name="has_part",
            slot_type=MacromoleculeHasPartAssociation,
            key_name="object",
            keyed=False,
        )
...
class Association(YAMLRoot):
    ...
    has_evidence: Optional[
        Union[
            Dict[Union[str, EvidenceId], Union[dict, "Evidence"]],
            List[Union[dict, "Evidence"]],
        ]
    ] = empty_dict()
    subject: Optional[Union[str, DomainEntityId]] = None
    predicate: Optional[Union[str, PredicateType]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_list(
            slot_name="has_evidence", slot_type=Evidence, key_name="id", keyed=True
        )
...
class ActivityToActivityCausalAssociation(CausalAssociation):
    ...
    class_model_uri: ClassVar[URIRef] = (
        GOCAM_QUERIES.ActivityToActivityCausalAssociation
    )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.subject is not None and not isinstance(
            self.subject, MolecularActivityId
        ):
...
class ProcessToProcessCausalAssociation(CausalAssociation):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.subject is not None and not isinstance(
            self.subject, BiologicalProcessId
        ):
...
class Evidence(InformationEntity):
    ...
    date: Optional[str] = None
    reference: Optional[
        Union[Union[str, PublicationId], List[Union[str, PublicationId]]]
    ] = empty_list()
    with_object: Optional[Union[Union[str, EntityId], List[Union[str, EntityId]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.reference = [
            v if isinstance(v, PublicationId) else PublicationId(v)
            for v in self.reference
        ]

        if not isinstance(self.with_object, list):
            self.with_object = (
                [self.with_object] if self.with_object is not None else []
            )
        self.with_object = [
            v if isinstance(v, EntityId) else EntityId(v) for v in self.with_object
        ]
...
class CausalPredicateEnum(EnumDefinitionImpl):
    ...
    regulates = PermissibleValue(text="regulates", meaning=RO["0002211"])
    ...
    def _addvals(cls):
        setattr(
            ...
            PermissibleValue(
                text="causally upstream of, positive effect", meaning=RO["0002304"]
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="causally upstream of, negative effect", meaning=RO["0002305"]
            ),
        )
        setattr(
            cls,
            "causally upstream of",
            PermissibleValue(text="causally upstream of", meaning=RO["0002411"]),
        )
        setattr(
            cls,
            "immediately causally upstream of",
            PermissibleValue(
                text="immediately causally upstream of", meaning=RO["0002412"]
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="causally upstream of or within", meaning=RO["0002418"]
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(text="negatively regulates", meaning=RO["0002212"]),
        )
        setattr(
            cls,
            "positively regulates",
            PermissibleValue(text="positively regulates", meaning=RO["0002213"]),
        )
...
slots.aggregate_count = Slot(
    uri=GOCAM_QUERIES.aggregate_count,
    name="aggregate_count",
    curie=GOCAM_QUERIES.curie("aggregate_count"),
    model_uri=GOCAM_QUERIES.aggregate_count,
    domain=None,
    range=Optional[int],
)

slots.model_count = Slot(
    uri=GOCAM_QUERIES.model_count,
    name="model_count",
    curie=GOCAM_QUERIES.curie("model_count"),
    model_uri=GOCAM_QUERIES.model_count,
    domain=None,
    range=Optional[int],
)

slots.activity_count = Slot(
    uri=GOCAM_QUERIES.activity_count,
    name="activity_count",
    curie=GOCAM_QUERIES.curie("activity_count"),
    model_uri=GOCAM_QUERIES.activity_count,
    domain=None,
    range=Optional[int],
)

slots.minimum_connected_entity_count = Slot(
    uri=GOCAM_QUERIES.minimum_connected_entity_count,
    name="minimum_connected_entity_count",
    curie=GOCAM_QUERIES.curie("minimum_connected_entity_count"),
    model_uri=GOCAM_QUERIES.minimum_connected_entity_count,
    domain=None,
    range=Optional[int],
)

slots.title_regex = Slot(
    uri=GOCAM_QUERIES.title_regex,
    name="title_regex",
    curie=GOCAM_QUERIES.curie("title_regex"),
    model_uri=GOCAM_QUERIES.title_regex,
    domain=None,
    range=Optional[str],
)

slots.graph = Slot(
    uri=GOCAM_QUERIES.graph,
    name="graph",
    curie=GOCAM_QUERIES.curie("graph"),
    model_uri=GOCAM_QUERIES.graph,
    domain=None,
    range=Optional[str],
)
...
slots.results = Slot(
    ...
    model_uri=GOCAM_QUERIES.results,
    domain=None,
...
slots.binding_key = Slot(
    ...
    model_uri=GOCAM_QUERIES.binding_key,
    domain=None,
    range=URIRef,
)
...
slots.binding_value = Slot(
    ...
    model_uri=GOCAM_QUERIES.binding_value,
    domain=None,
    range=Optional[str],
)
...
slots.query_template = Slot(
    ...
    model_uri=GOCAM_QUERIES.query_template,
    domain=None,
    range=Optional[str],
)
...
slots.bindings = Slot(
    ...
    model_uri=GOCAM_QUERIES.bindings,
    domain=None,
    range=Optional[
        Union[
...
slots.id = Slot(
    uri=GOCAM.id,
    name="id",
    curie=GOCAM.curie("id"),
    model_uri=GOCAM_QUERIES.id,
    domain=None,
    range=URIRef,
)
...
slots.category = Slot(
    uri=GOCAM.category,
    name="category",
    curie=GOCAM.curie("category"),
    model_uri=GOCAM_QUERIES.category,
    domain=None,
    range=Union[str, CategoryType],
)

slots.with_object = Slot(
    uri=LEGO.evidence,
    name="with object",
    curie=LEGO.curie("evidence"),
    model_uri=GOCAM_QUERIES.with_object,
    domain=None,
...
slots.reference = Slot(
    uri=DCE.source,
    name="reference",
    curie=DCE.curie("source"),
    model_uri=GOCAM_QUERIES.reference,
    domain=None,
...
slots.provided_by = Slot(
    uri=PAV.providedBy,
    name="provided_by",
    curie=PAV.curie("providedBy"),
    model_uri=GOCAM_QUERIES.provided_by,
    domain=None,
    range=Optional[str],
)
...
slots.contributor = Slot(
    uri=DCE.contributor,
    name="contributor",
    curie=DCE.curie("contributor"),
    model_uri=GOCAM_QUERIES.contributor,
    domain=None,
...
slots.date = Slot(
    uri=DCE.date,
    name="date",
    curie=DCE.curie("date"),
    model_uri=GOCAM_QUERIES.date,
    domain=None,
    range=Optional[str],
)

slots.evidence_type = Slot(
    uri=GOCAM.evidence_type,
    name="evidence type",
    curie=GOCAM.curie("evidence_type"),
    model_uri=GOCAM_QUERIES.evidence_type,
    domain=None,
    range=Union[str, OntologyClassId],
    pattern=re.compile(r"^ECO:\d+$"),
)

slots.type_inferences = Slot(
    uri=GOCAM.type_inferences,
    name="type inferences",
    curie=GOCAM.curie("type_inferences"),
    model_uri=GOCAM_QUERIES.type_inferences,
    domain=None,
    range=Optional[
        Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]
    ],
...
slots.related_to = Slot(
    uri=GOCAM.related_to,
    name="related to",
    curie=GOCAM.curie("related_to"),
    model_uri=GOCAM_QUERIES.related_to,
    domain=None,
...
slots.occurs_in = Slot(
    uri=GOCAM.occurs_in,
    name="occurs in",
    curie=GOCAM.curie("occurs_in"),
    model_uri=GOCAM_QUERIES.occurs_in,
    domain=None,
    range=Optional[
        Union[Union[dict, OccursInAssociation], List[Union[dict, OccursInAssociation]]]
    ],
)

slots.has_causal_associations = Slot(
    uri=GOCAM.has_causal_associations,
    name="has causal associations",
    curie=GOCAM.curie("has_causal_associations"),
    model_uri=GOCAM_QUERIES.has_causal_associations,
    domain=None,
    range=Optional[
        Union[Union[dict, CausalAssociation], List[Union[dict, CausalAssociation]]]
    ],
)

slots.has_activity_causal_associations = Slot(
    uri=GOCAM.has_activity_causal_associations,
    name="has activity causal associations",
    curie=GOCAM.curie("has_activity_causal_associations"),
    model_uri=GOCAM_QUERIES.has_activity_causal_associations,
    domain=None,
    range=Optional[
        Union[
            Union[dict, CausalAssociationToActivity],
            List[Union[dict, CausalAssociationToActivity]],
        ]
    ],
)

slots.has_process_causal_associations = Slot(
    uri=GOCAM.has_process_causal_associations,
    name="has process causal associations",
    curie=GOCAM.curie("has_process_causal_associations"),
    model_uri=GOCAM_QUERIES.has_process_causal_associations,
    domain=None,
    range=Optional[
        Union[
            Union[dict, CausalAssociationToProcess],
            List[Union[dict, CausalAssociationToProcess]],
        ]
    ],
)

slots.happens_during = Slot(
    uri=GOCAM.happens_during,
    name="happens during",
    curie=GOCAM.curie("happens_during"),
    model_uri=GOCAM_QUERIES.happens_during,
    domain=None,
    range=Optional[
        Union[
            Union[dict, HappensDuringAssociation],
...
slots.part_of = Slot(
    uri=GOCAM.part_of,
    name="part of",
    curie=GOCAM.curie("part_of"),
    model_uri=GOCAM_QUERIES.part_of,
    domain=None,
    range=Optional[
        Union[Union[dict, PartOfAssociation], List[Union[dict, PartOfAssociation]]]
    ],
)
...
slots.has_part = Slot(
    uri=GOCAM.has_part,
    name="has part",
    curie=GOCAM.curie("has_part"),
    model_uri=GOCAM_QUERIES.has_part,
    domain=None,
    range=Optional[
        Union[Union[dict, HasPartAssociation], List[Union[dict, HasPartAssociation]]]
    ],
)
...
slots.enabled_by = Slot(
    uri=RO["0002333"],
    name="enabled by",
    curie=RO.curie("0002333"),
    model_uri=GOCAM_QUERIES.enabled_by,
...
slots.has_input = Slot(
    uri=GOCAM.has_input,
    name="has input",
    curie=GOCAM.curie("has_input"),
    model_uri=GOCAM_QUERIES.has_input,
    domain=None,
    range=Optional[
        Union[Union[dict, HasInputAssociation], List[Union[dict, HasInputAssociation]]]
    ],
)

slots.has_evidence = Slot(
    uri=GOCAM.has_evidence,
    name="has evidence",
    curie=GOCAM.curie("has_evidence"),
    model_uri=GOCAM_QUERIES.has_evidence,
    domain=Association,
    range=Optional[
        Union[
            Dict[Union[str, EvidenceId], Union[dict, "Evidence"]],
...
slots.association_slot = Slot(
    uri=GOCAM.association_slot,
    name="association slot",
    curie=GOCAM.curie("association_slot"),
    model_uri=GOCAM_QUERIES.association_slot,
    domain=Association,
    range=Optional[str],
)
...
slots.subject = Slot(
    ...
    model_uri=GOCAM_QUERIES.subject,
    domain=Association,
    range=Optional[Union[str, DomainEntityId]],
)
...
slots.object = Slot(
    ...
    model_uri=GOCAM_QUERIES.object,
    domain=Association,
...
slots.predicate = Slot(
    ...
    model_uri=GOCAM_QUERIES.predicate,
    domain=Association,
    range=Optional[Union[str, PredicateType]],
)

slots.model_property = Slot(
    uri=GOCAM.model_property,
    name="model property",
    curie=GOCAM.curie("model_property"),
    model_uri=GOCAM_QUERIES.model_property,
    domain=None,
    range=Optional[str],
)
...
slots.title = Slot(
    uri=DCE.title,
    name="title",
    curie=DCE.curie("title"),
    model_uri=GOCAM_QUERIES.title,
    domain=None,
    range=Optional[str],
)
...
slots.state = Slot(
    uri=LEGO.modelstate,
    name="state",
    curie=LEGO.curie("modelstate"),
    model_uri=GOCAM_QUERIES.state,
    domain=None,
    range=Optional[Union[str, "ModelStateEnum"]],
)

slots.domain_entity_set = Slot(
    uri=GOCAM.domain_entity_set,
    name="domain entity set",
    curie=GOCAM.curie("domain_entity_set"),
    model_uri=GOCAM_QUERIES.domain_entity_set,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, DomainEntityId], Union[dict, DomainEntity]],
            List[Union[dict, DomainEntity]],
        ]
    ],
)

slots.molecular_activity_set = Slot(
    uri=GOCAM.molecular_activity_set,
    name="molecular activity set",
    curie=GOCAM.curie("molecular_activity_set"),
    model_uri=GOCAM_QUERIES.molecular_activity_set,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, MolecularActivityId], Union[dict, MolecularActivity]],
...
slots.biological_process_set = Slot(
    uri=GOCAM.biological_process_set,
    name="biological process set",
    curie=GOCAM.curie("biological_process_set"),
    model_uri=GOCAM_QUERIES.biological_process_set,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, BiologicalProcessId], Union[dict, BiologicalProcess]],
...
slots.information_biomacromolecule_set = Slot(
    uri=GOCAM.information_biomacromolecule_set,
    name="information biomacromolecule set",
    curie=GOCAM.curie("information_biomacromolecule_set"),
    model_uri=GOCAM_QUERIES.information_biomacromolecule_set,
    domain=None,
    range=Optional[
        Union[
            Dict[
...
slots.chemical_entity_set = Slot(
    uri=GOCAM.chemical_entity_set,
    name="chemical entity set",
    curie=GOCAM.curie("chemical_entity_set"),
    model_uri=GOCAM_QUERIES.chemical_entity_set,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, ChemicalEntityId], Union[dict, ChemicalEntity]],
...
slots.ontology_class_set = Slot(
    uri=GOCAM.ontology_class_set,
    name="ontology class set",
    curie=GOCAM.curie("ontology_class_set"),
    model_uri=GOCAM_QUERIES.ontology_class_set,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, OntologyClassId], Union[dict, OntologyClass]],
...
slots.model_query_results = Slot(
    uri=RESULTSET.results,
    name="model query_results",
    curie=RESULTSET.curie("results"),
    model_uri=GOCAM_QUERIES.model_query_results,
    domain=ModelQuery,
    range=Optional[Union[Union[str, ModelId], List[Union[str, ModelId]]]],
)

slots.molecular_activity_part_of = Slot(
    uri=GOCAM.part_of,
    name="molecular activity_part of",
    curie=GOCAM.curie("part_of"),
    model_uri=GOCAM_QUERIES.molecular_activity_part_of,
    domain=MolecularActivity,
    range=Optional[
        Union[
            Union[dict, "ProcessPartOfAssociation"],
...
slots.molecular_activity_has_activity_causal_associations = Slot(
    uri=GOCAM.has_activity_causal_associations,
    name="molecular activity_has activity causal associations",
    curie=GOCAM.curie("has_activity_causal_associations"),
    model_uri=GOCAM_QUERIES.molecular_activity_has_activity_causal_associations,
    domain=MolecularActivity,
    range=Optional[
        Union[
            Union[dict, "ActivityToActivityCausalAssociation"],
...
slots.molecular_activity_has_process_causal_associations = Slot(
    uri=GOCAM.has_process_causal_associations,
    name="molecular activity_has process causal associations",
    curie=GOCAM.curie("has_process_causal_associations"),
    model_uri=GOCAM_QUERIES.molecular_activity_has_process_causal_associations,
    domain=MolecularActivity,
    range=Optional[
        Union[
            Union[dict, "ActivityToProcessCausalAssociation"],
...
slots.biological_process_has_activity_causal_associations = Slot(
    uri=GOCAM.has_activity_causal_associations,
    name="biological process_has activity causal associations",
    curie=GOCAM.curie("has_activity_causal_associations"),
    model_uri=GOCAM_QUERIES.biological_process_has_activity_causal_associations,
...
slots.biological_process_has_process_causal_associations = Slot(
    uri=GOCAM.has_process_causal_associations,
    name="biological process_has process causal associations",
    curie=GOCAM.curie("has_process_causal_associations"),
    model_uri=GOCAM_QUERIES.biological_process_has_process_causal_associations,
    domain=BiologicalProcess,
    range=Optional[
        Union[
            Union[dict, "ProcessToProcessCausalAssociation"],
...
slots.anatomical_entity_category = Slot(
    uri=GOCAM.category,
    name="anatomical entity_category",
    curie=GOCAM.curie("category"),
    model_uri=GOCAM_QUERIES.anatomical_entity_category,
    domain=AnatomicalEntity,
    range=Union[str, "AnatomicalEntityCategory"],
)

slots.anatomical_entity_part_of = Slot(
    uri=GOCAM.part_of,
    name="anatomical entity_part of",
    curie=GOCAM.curie("part_of"),
    model_uri=GOCAM_QUERIES.anatomical_entity_part_of,
    domain=AnatomicalEntity,
    range=Optional[
        Union[
            Union[dict, "AnatomicalPartOfAssociation"],
...
slots.information_biomacromolecule_category = Slot(
    uri=GOCAM.category,
    name="information biomacromolecule_category",
    curie=GOCAM.curie("category"),
    model_uri=GOCAM_QUERIES.information_biomacromolecule_category,
    domain=InformationBiomacromolecule,
    range=Union[str, "InformationBiomacromoleculeCategory"],
)

slots.information_biomacromolecule_has_part = Slot(
    uri=GOCAM.has_part,
    name="information biomacromolecule_has part",
    curie=GOCAM.curie("has_part"),
    model_uri=GOCAM_QUERIES.information_biomacromolecule_has_part,
    domain=InformationBiomacromolecule,
    range=Optional[
        Union[
            Union[dict, "MacromoleculeHasPartAssociation"],
...
slots.occurs_in_association_object = Slot(
    uri=RDF.object,
    name="occurs in association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.occurs_in_association_object,
    domain=OccursInAssociation,
    range=Union[str, AnatomicalEntityId],
)

slots.causal_association_subject = Slot(
    uri=RDF.subject,
    name="causal association_subject",
    curie=RDF.curie("subject"),
    model_uri=GOCAM_QUERIES.causal_association_subject,
    domain=CausalAssociation,
    range=Optional[Union[str, DomainEntityId]],
)

slots.causal_association_object = Slot(
    uri=RDF.object,
    name="causal association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.causal_association_object,
    domain=CausalAssociation,
    range=Union[str, ActivityOrProcessId],
)

slots.causal_association_predicate = Slot(
    uri=RDF.predicate,
    name="causal association_predicate",
    curie=RDF.curie("predicate"),
    model_uri=GOCAM_QUERIES.causal_association_predicate,
    domain=CausalAssociation,
    range=Optional[Union[str, PredicateType]],
)

slots.causal_association_to_activity_object = Slot(
    uri=RDF.object,
    name="causal association to activity_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.causal_association_to_activity_object,
    domain=None,
    range=Union[str, MolecularActivityId],
)

slots.causal_association_to_process_object = Slot(
    uri=RDF.object,
    name="causal association to process_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.causal_association_to_process_object,
    domain=None,
    range=Union[str, BiologicalProcessId],
)

slots.activity_to_activity_causal_association_subject = Slot(
    uri=RDF.subject,
    name="activity to activity causal association_subject",
    curie=RDF.curie("subject"),
    model_uri=GOCAM_QUERIES.activity_to_activity_causal_association_subject,
    domain=ActivityToActivityCausalAssociation,
    range=Optional[Union[str, MolecularActivityId]],
)

slots.activity_to_activity_causal_association_object = Slot(
    uri=RDF.object,
    name="activity to activity causal association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.activity_to_activity_causal_association_object,
    domain=ActivityToActivityCausalAssociation,
    range=Union[str, MolecularActivityId],
)

slots.process_to_process_causal_association_subject = Slot(
    uri=RDF.subject,
    name="process to process causal association_subject",
    curie=RDF.curie("subject"),
    model_uri=GOCAM_QUERIES.process_to_process_causal_association_subject,
    domain=ProcessToProcessCausalAssociation,
    range=Optional[Union[str, BiologicalProcessId]],
)

slots.process_to_process_causal_association_object = Slot(
    uri=RDF.object,
    name="process to process causal association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.process_to_process_causal_association_object,
    domain=ProcessToProcessCausalAssociation,
    range=Union[str, BiologicalProcessId],
)

slots.process_to_activity_causal_association_subject = Slot(
    uri=RDF.subject,
    name="process to activity causal association_subject",
    curie=RDF.curie("subject"),
    model_uri=GOCAM_QUERIES.process_to_activity_causal_association_subject,
    domain=ProcessToActivityCausalAssociation,
    range=Optional[Union[str, BiologicalProcessId]],
)

slots.process_to_activity_causal_association_object = Slot(
    uri=RDF.object,
    name="process to activity causal association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.process_to_activity_causal_association_object,
    domain=ProcessToActivityCausalAssociation,
    range=Union[str, MolecularActivityId],
)

slots.activity_to_process_causal_association_subject = Slot(
    uri=RDF.subject,
    name="activity to process causal association_subject",
    curie=RDF.curie("subject"),
    model_uri=GOCAM_QUERIES.activity_to_process_causal_association_subject,
    domain=ActivityToProcessCausalAssociation,
    range=Optional[Union[str, MolecularActivityId]],
)

slots.activity_to_process_causal_association_object = Slot(
    uri=RDF.object,
    name="activity to process causal association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.activity_to_process_causal_association_object,
    domain=ActivityToProcessCausalAssociation,
    range=Union[str, BiologicalProcessId],
)

slots.macromolecule_has_part_association_object = Slot(
    uri=RDF.object,
    name="macromolecule has part association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.macromolecule_has_part_association_object,
    domain=MacromoleculeHasPartAssociation,
    range=Union[str, ContinuantId],
)

slots.anatomical_part_of_association_object = Slot(
    uri=RDF.object,
    name="anatomical part of association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.anatomical_part_of_association_object,
    domain=AnatomicalPartOfAssociation,
    range=Union[str, AnatomicalEntityId],
)

slots.process_part_of_association_object = Slot(
    uri=RDF.object,
    name="process part of association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.process_part_of_association_object,
    domain=ProcessPartOfAssociation,
    range=Union[str, BiologicalProcessId],
)

slots.enabled_by_association_object = Slot(
    uri=RDF.object,
    name="enabled by association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.enabled_by_association_object,
    domain=EnabledByAssociation,
    range=Union[str, InformationBiomacromoleculeId],
)

slots.happens_during_association_object = Slot(
    uri=RDF.object,
    name="happens during association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.happens_during_association_object,
    domain=HappensDuringAssociation,
    range=Union[str, ActivityOrProcessId],
)

slots.has_input_association_object = Slot(
    uri=RDF.object,
    name="has input association_object",
    curie=RDF.curie("object"),
    model_uri=GOCAM_QUERIES.has_input_association_object,
    domain=HasInputAssociation,
    range=Union[str, ContinuantId],
)
