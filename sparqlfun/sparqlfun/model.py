...
SPARQLFUN_BIOLINK = CurieNamespace(
...
SPARQLFUN_UBERGRAPH = CurieNamespace(
...
class Statement(Quad):
    ...
    node_statements: Optional[
        Union[
            Union[dict, "NodeToNodeStatement"], List[Union[dict, "NodeToNodeStatement"]]
        ]
    ] = empty_list()
    value_statements: Optional[
        Union[
            Union[dict, "NodeToValueStatement"],
            List[Union[dict, "NodeToValueStatement"]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if not isinstance(self.node_statements, list):
            self.node_statements = (
                [self.node_statements] if self.node_statements is not None else []
            )
        self.node_statements = [
            (
                v
                if isinstance(v, NodeToNodeStatement)
                else NodeToNodeStatement(**as_dict(v))
            )
            for v in self.node_statements
        ]

        if not isinstance(self.value_statements, list):
            self.value_statements = (
                [self.value_statements] if self.value_statements is not None else []
            )
        self.value_statements = [
            (
                v
                if isinstance(v, NodeToValueStatement)
                else NodeToValueStatement(**as_dict(v))
            )
            for v in self.value_statements
        ]
...
class NodeObject(Node):
    ...
    node_statements: Optional[
        Union[Union[dict, NodeToNodeStatement], List[Union[dict, NodeToNodeStatement]]]
    ] = empty_list()
    value_statements: Optional[
        Union[
            Union[dict, NodeToValueStatement], List[Union[dict, NodeToValueStatement]]
        ]
    ] = empty_list()
...
class BasicClass(Node):
    ...
    subClassOf: Optional[
        Union[Union[str, ClassNodeId], List[Union[str, ClassNodeId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.subClassOf = [
            v if isinstance(v, ClassNodeId) else ClassNodeId(v) for v in self.subClassOf
        ]
...
class DescribeEquivalentExpression(ResultSet):
    ...
    results: Optional[Union[Union[str, ClassNodeId], List[Union[str, ClassNodeId]]]] = (
        empty_list()
    )
    subject: Optional[Union[str, NodeId]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if not isinstance(self.results, list):
            self.results = [self.results] if self.results is not None else []
        self.results = [
            v if isinstance(v, ClassNodeId) else ClassNodeId(v) for v in self.results
        ]
...
class OwlTripleAnnotation(Triple):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.axiom_identifier is not None and not isinstance(
            self.axiom_identifier, BlankNodeId
        ):
            self.axiom_identifier = BlankNodeId(self.axiom_identifier)

        if self.axiom_predicate is not None and not isinstance(
            self.axiom_predicate, PropertyNodeId
        ):
...
class OwlTripleWithAnnotationsTODO(Triple):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.annotations is not None and not isinstance(
            self.annotations, OwlAnnotation
        ):
...
class TraversalBasedPairwiseDisjointnessViolation(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_OWL.TraversalBasedPairwiseDisjointnessViolation
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_owl:TraversalBasedPairwiseDisjointnessViolation"
    )
    class_name: ClassVar[str] = "traversal based pairwise disjointness violation"
    class_model_uri: ClassVar[URIRef] = (
        SPARQLFUN.TraversalBasedPairwiseDisjointnessViolation
    )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.descendant_class is not None and not isinstance(
            self.descendant_class, NodeId
        ):
...
class TaxonApplicable(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.subject is not None and not isinstance(
            self.subject, TaxonApplicableClassId
        ):
...
class OboClass(GraphClassNode):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.exact_synonyms, list):
            self.exact_synonyms = (
                [self.exact_synonyms] if self.exact_synonyms is not None else []
            )
        self.exact_synonyms = [
            v if isinstance(v, str) else str(v) for v in self.exact_synonyms
        ]
...
class OboClassQuery(ResultSet):
    ...
    results: Optional[Union[Union[str, OboClassId], List[Union[str, OboClassId]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if not isinstance(self.results, list):
            self.results = [self.results] if self.results is not None else []
        self.results = [
            v if isinstance(v, OboClassId) else OboClassId(v) for v in self.results
        ]
...
class NormalizedInformationContentTriple(Triple):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.NormalizedInformationContentTriple
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:NormalizedInformationContentTriple"
    )
...
class ClassTaxonExclusionViaNeverIn(Triple):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.ClassTaxonExclusionViaNeverIn
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:ClassTaxonExclusionViaNeverIn"
    )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.subject_predicate is not None and not isinstance(
            self.subject_predicate, NodeId
        ):
            self.subject_predicate = NodeId(self.subject_predicate)

        if self.class_with_constraint is not None and not isinstance(
            self.class_with_constraint, NodeId
        ):
...
class ClassTaxonExclusionViaOnlyIn(Triple):
    ...
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:ClassTaxonExclusionViaOnlyIn"
    )
...
class SetwiseCommonSubClassAncestor(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.SetwiseCommonSubClassAncestor
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:SetwiseCommonSubClassAncestor"
    )
...
class SetwiseMostRecentCommonSubClassAncestor(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.SetwiseMostRecentCommonSubClassAncestor
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:SetwiseMostRecentCommonSubClassAncestor"
    )
    ...
    class_model_uri: ClassVar[URIRef] = (
        SPARQLFUN.SetwiseMostRecentCommonSubClassAncestor
    )
...
class PairwiseCommonAncestor(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.predicate1 is not None and not isinstance(
            self.predicate1, PropertyNodeId
        ):
            self.predicate1 = PropertyNodeId(self.predicate1)

        if self.predicate2 is not None and not isinstance(
            self.predicate2, PropertyNodeId
        ):
...
class PairwiseCommonSubClassAncestor(PairwiseCommonAncestor):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.PairwiseCommonSubClassAncestor
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:PairwiseCommonSubClassAncestor"
    )
...
class PairwiseMostRecentCommonAncestor(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.PairwiseMostRecentCommonAncestor
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:PairwiseMostRecentCommonAncestor"
    )
...
class PairwiseMostRecentCommonSubClassAncestor(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.PairwiseMostRecentCommonSubClassAncestor
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:PairwiseMostRecentCommonSubClassAncestor"
    )
    ...
    class_model_uri: ClassVar[URIRef] = (
        SPARQLFUN.PairwiseMostRecentCommonSubClassAncestor
    )
...
class PairwiseCommonDescendant(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.is_direction_canonical is not None and not isinstance(
            self.is_direction_canonical, Bool
        ):
...
class PairwiseCommonSubClassDescendant(PairwiseCommonDescendant):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.PairwiseCommonSubClassDescendant
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:PairwiseCommonSubClassDescendant"
    )
...
class PairwiseCommonDescendantMatrix(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.PairwiseCommonDescendantMatrix
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:PairwiseCommonDescendantMatrix"
    )
    ...
    node1: Optional[Union[str, NodeId]] = None
    node2: Optional[Union[str, NodeId]] = None
    node1_candidates: Optional[Union[Union[str, NodeId], List[Union[str, NodeId]]]] = (
        empty_list()
    )
    node2_candidates: Optional[Union[Union[str, NodeId], List[Union[str, NodeId]]]] = (
        empty_list()
    )
    predicate1: Optional[Union[str, PropertyNodeId]] = None
    predicate2: Optional[Union[str, PropertyNodeId]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.node1_candidates, list):
            self.node1_candidates = (
                [self.node1_candidates] if self.node1_candidates is not None else []
            )
        self.node1_candidates = [
            v if isinstance(v, NodeId) else NodeId(v) for v in self.node1_candidates
        ]

        if not isinstance(self.node2_candidates, list):
            self.node2_candidates = (
                [self.node2_candidates] if self.node2_candidates is not None else []
            )
        self.node2_candidates = [
            v if isinstance(v, NodeId) else NodeId(v) for v in self.node2_candidates
        ]
...
class PairwiseCommonSubClassDescendantMatrix(PairwiseCommonDescendantMatrix):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_UBERGRAPH.PairwiseCommonSubClassDescendantMatrix
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_ubergraph:PairwiseCommonSubClassDescendantMatrix"
    )
...
class BloodVessel(OboClass):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.subcategory is not None and not isinstance(
            self.subcategory, BloodVesselSubcategory
        ):
            self.subcategory = BloodVesselSubcategory(self.subcategory)

        if self.supplies is not None and not isinstance(
            self.supplies, AnatomicalEntityId
        ):
        ...
        if self.branching_part_of is not None and not isinstance(
            self.branching_part_of, AnatomicalEntityId
        ):
...
class AssociationWithInferredCategories(Statement):
    ...
    class_class_uri: ClassVar[URIRef] = (
        SPARQLFUN_BIOLINK.AssociationWithInferredCategories
    )
    class_class_curie: ClassVar[str] = (
        "sparqlfun_biolink:AssociationWithInferredCategories"
    )
...
class Protein(Thing):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.mappedCitation is not None and not isinstance(
            self.mappedCitation, CitationId
        ):
        ...
        if self.mappedAnnotation is not None and not isinstance(
            self.mappedAnnotation, Annotation
        ):
            self.mappedAnnotation = Annotation()

        if self.classifiedWith is not None and not isinstance(
            self.classifiedWith, ConceptId
        ):
        ...
        if self.representativeFor is not None and not isinstance(
            self.representativeFor, ClusterId
        ):
        ...
        if self.conflictingSequence is not None and not isinstance(
            self.conflictingSequence, ExternalSequence
        ):
            self.conflictingSequence = ExternalSequence()

        if self.potentialSequence is not None and not isinstance(
        ...
        if self.alternativeName is not None and not isinstance(
        ...
        if self.recommendedName is not None and not isinstance(
            self.recommendedName, StructuredName
        ):
            self.recommendedName = StructuredName()

        if self.submittedName is not None and not isinstance(
...
class ErroneousGeneModelPredictionAnnotation(SequenceCautionAnnotation):
    ...
    class_class_uri: ClassVar[URIRef] = (
        UPCORE.Erroneous_Gene_Model_Prediction_Annotation
    )
    class_class_curie: ClassVar[str] = (
        "upcore:Erroneous_Gene_Model_Prediction_Annotation"
    )
...
class BloodVesselSubcategory(EnumDefinitionImpl):
    ...
    artery = PermissibleValue(text="artery", meaning=UBERON["0001637"])
    vein = PermissibleValue(text="vein", meaning=UBERON["0001638"])
...
slots.binding_key = Slot(
    ...
    model_uri=SPARQLFUN.binding_key,
    domain=None,
    range=URIRef,
)
...
slots.binding_value = Slot(
    ...
    model_uri=SPARQLFUN.binding_value,
    domain=None,
    range=Optional[str],
)
...
slots.query_template = Slot(
    ...
    model_uri=SPARQLFUN.query_template,
    domain=None,
    range=Optional[str],
)
...
slots.id = Slot(
    uri=SPARQLFUN_RDF.id,
    name="id",
    curie=SPARQLFUN_RDF.curie("id"),
    model_uri=SPARQLFUN.id,
    domain=None,
    range=URIRef,
)
...
slots.predicate = Slot(
    ...
    model_uri=SPARQLFUN.predicate,
    domain=None,
    range=Optional[Union[str, PropertyNodeId]],
)
...
slots.object = Slot(
    ...
    model_uri=SPARQLFUN.object,
    domain=None,
    range=Optional[Union[dict, NodeOrLiteral]],
)

slots.value_object = Slot(
    uri=SPARQLFUN_RDF.value_object,
    name="value_object",
    curie=SPARQLFUN_RDF.curie("value_object"),
    model_uri=SPARQLFUN.value_object,
    domain=None,
    range=Optional[str],
)

slots.node_object = Slot(
    uri=SPARQLFUN_RDF.node_object,
    name="node_object",
    curie=SPARQLFUN_RDF.curie("node_object"),
    model_uri=SPARQLFUN.node_object,
    domain=None,
    range=Optional[Union[str, NodeId]],
)
...
slots.statements = Slot(
    ...
    model_uri=SPARQLFUN.statements,
    domain=None,
    range=Optional[Union[Union[dict, Statement], List[Union[dict, Statement]]]],
)

slots.value_statements = Slot(
    uri=SPARQLFUN.value_statements,
    name="value_statements",
    curie=SPARQLFUN.curie("value_statements"),
    model_uri=SPARQLFUN.value_statements,
    domain=None,
    range=Optional[
        Union[
            Union[dict, NodeToValueStatement], List[Union[dict, NodeToValueStatement]]
...
slots.node_statements = Slot(
    uri=SPARQLFUN.node_statements,
    name="node_statements",
    curie=SPARQLFUN.curie("node_statements"),
    model_uri=SPARQLFUN.node_statements,
    domain=None,
    range=Optional[
        Union[Union[dict, NodeToNodeStatement], List[Union[dict, NodeToNodeStatement]]]
    ],
...
slots.label = Slot(
    ...
    model_uri=SPARQLFUN.label,
    domain=None,
    range=Optional[str],
)

slots.category = Slot(
    uri=SPARQLFUN_RDF.category,
    name="category",
    curie=SPARQLFUN_RDF.curie("category"),
    model_uri=SPARQLFUN.category,
    domain=None,
    range=Optional[Union[str, ClassNodeId]],
)

slots.datatype = Slot(
    uri=SPARQLFUN_RDF.datatype,
    name="datatype",
    curie=SPARQLFUN_RDF.curie("datatype"),
    model_uri=SPARQLFUN.datatype,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.value = Slot(
    uri=SPARQLFUN_RDF.value,
    name="value",
    curie=SPARQLFUN_RDF.curie("value"),
    model_uri=SPARQLFUN.value,
    domain=None,
    range=Optional[Union[str, LiteralAsStringType]],
)

slots.language = Slot(
    uri=SPARQLFUN_RDF.language,
    name="language",
    curie=SPARQLFUN_RDF.curie("language"),
    model_uri=SPARQLFUN.language,
    domain=None,
    range=Optional[str],
)
...
slots.description = Slot(
    ...
    model_uri=SPARQLFUN.description,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.regex_slot = Slot(
    uri=SPARQLFUN_RDF.regex_slot,
    name="regex_slot",
    curie=SPARQLFUN_RDF.curie("regex_slot"),
    model_uri=SPARQLFUN.regex_slot,
    domain=None,
    range=Optional[str],
)

slots.class1 = Slot(
    uri=SPARQLFUN_OWL.class1,
    name="class1",
    curie=SPARQLFUN_OWL.curie("class1"),
    model_uri=SPARQLFUN.class1,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.class2 = Slot(
    uri=SPARQLFUN_OWL.class2,
    name="class2",
    curie=SPARQLFUN_OWL.curie("class2"),
    model_uri=SPARQLFUN.class2,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.descendant_class = Slot(
    uri=SPARQLFUN_OWL.descendant_class,
    name="descendant_class",
    curie=SPARQLFUN_OWL.curie("descendant_class"),
    model_uri=SPARQLFUN.descendant_class,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.axiom_identifier = Slot(
    uri=SPARQLFUN_OWL.axiom_identifier,
    name="axiom_identifier",
    curie=SPARQLFUN_OWL.curie("axiom_identifier"),
    model_uri=SPARQLFUN.axiom_identifier,
    domain=None,
    range=Optional[Union[str, BlankNodeId]],
)

slots.filler = Slot(
    uri=SPARQLFUN_OWL.filler,
    name="filler",
    curie=SPARQLFUN_OWL.curie("filler"),
    model_uri=SPARQLFUN.filler,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.axiom_predicate = Slot(
    uri=SPARQLFUN_OWL.axiom_predicate,
    name="axiom_predicate",
    curie=SPARQLFUN_OWL.curie("axiom_predicate"),
    model_uri=SPARQLFUN.axiom_predicate,
    domain=None,
    range=Optional[Union[str, PropertyNodeId]],
)

slots.axiom_object = Slot(
    uri=SPARQLFUN_OWL.axiom_object,
    name="axiom_object",
    curie=SPARQLFUN_OWL.curie("axiom_object"),
    model_uri=SPARQLFUN.axiom_object,
    domain=None,
    range=Optional[Union[dict, NodeOrLiteral]],
)

slots.annotations = Slot(
    uri=SPARQLFUN_OWL.annotations,
    name="annotations",
    curie=SPARQLFUN_OWL.curie("annotations"),
    model_uri=SPARQLFUN.annotations,
    domain=None,
    range=Optional[Union[dict, OwlAnnotation]],
)

slots.label_regex = Slot(
    uri=SPARQLFUN_OMO.label_regex,
    name="label_regex",
    curie=SPARQLFUN_OMO.curie("label_regex"),
    model_uri=SPARQLFUN.label_regex,
    domain=None,
    range=Optional[str],
)

slots.label_starts_with = Slot(
    uri=SPARQLFUN_OMO.label_starts_with,
    name="label_starts_with",
    curie=SPARQLFUN_OMO.curie("label_starts_with"),
    model_uri=SPARQLFUN.label_starts_with,
    domain=None,
    range=Optional[str],
)

slots.xxresults = Slot(
    uri=SPARQLFUN_OMO.xxresults,
    name="xxresults",
    curie=SPARQLFUN_OMO.curie("xxresults"),
    model_uri=SPARQLFUN.xxresults,
    domain=None,
    range=Optional[
        Union[List[Union[str, NodeId]], Dict[Union[str, NodeId], Union[dict, Node]]]
    ],
)
...
slots.definition = Slot(
    ...
    model_uri=SPARQLFUN.definition,
    domain=None,
    range=Optional[str],
)

slots.exact_synonyms = Slot(
    uri=OBOINOWL.hasExactSynonym,
    name="exact_synonyms",
    curie=OBOINOWL.curie("hasExactSynonym"),
    model_uri=SPARQLFUN.exact_synonyms,
    domain=None,
    range=Optional[Union[str, List[str]]],
)

slots.ancestor = Slot(
    uri=SPARQLFUN_UBERGRAPH.ancestor,
    name="ancestor",
    curie=SPARQLFUN_UBERGRAPH.curie("ancestor"),
    model_uri=SPARQLFUN.ancestor,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.descendant = Slot(
    uri=SPARQLFUN_UBERGRAPH.descendant,
    name="descendant",
    curie=SPARQLFUN_UBERGRAPH.curie("descendant"),
    model_uri=SPARQLFUN.descendant,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.node1 = Slot(
    uri=SPARQLFUN_UBERGRAPH.node1,
    name="node1",
    curie=SPARQLFUN_UBERGRAPH.curie("node1"),
    model_uri=SPARQLFUN.node1,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.node2 = Slot(
    uri=SPARQLFUN_UBERGRAPH.node2,
    name="node2",
    curie=SPARQLFUN_UBERGRAPH.curie("node2"),
    model_uri=SPARQLFUN.node2,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.is_direction_canonical = Slot(
    uri=SPARQLFUN_UBERGRAPH.is_direction_canonical,
    name="is_direction_canonical",
    curie=SPARQLFUN_UBERGRAPH.curie("is_direction_canonical"),
    model_uri=SPARQLFUN.is_direction_canonical,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.node1_candidates = Slot(
    uri=SPARQLFUN_UBERGRAPH.node1_candidates,
    name="node1_candidates",
    curie=SPARQLFUN_UBERGRAPH.curie("node1_candidates"),
    model_uri=SPARQLFUN.node1_candidates,
    domain=None,
    range=Optional[Union[Union[str, NodeId], List[Union[str, NodeId]]]],
)

slots.node2_candidates = Slot(
    uri=SPARQLFUN_UBERGRAPH.node2_candidates,
    name="node2_candidates",
    curie=SPARQLFUN_UBERGRAPH.curie("node2_candidates"),
    model_uri=SPARQLFUN.node2_candidates,
    domain=None,
    range=Optional[Union[Union[str, NodeId], List[Union[str, NodeId]]]],
)

slots.nodes = Slot(
    uri=SPARQLFUN_UBERGRAPH.nodes,
    name="nodes",
    curie=SPARQLFUN_UBERGRAPH.curie("nodes"),
    model_uri=SPARQLFUN.nodes,
    domain=None,
    range=Optional[Union[Union[str, NodeId], List[Union[str, NodeId]]]],
)

slots.predicate1 = Slot(
    uri=SPARQLFUN_UBERGRAPH.predicate1,
    name="predicate1",
    curie=SPARQLFUN_UBERGRAPH.curie("predicate1"),
    model_uri=SPARQLFUN.predicate1,
    domain=None,
    range=Optional[Union[str, PropertyNodeId]],
)

slots.predicate2 = Slot(
    uri=SPARQLFUN_UBERGRAPH.predicate2,
    name="predicate2",
    curie=SPARQLFUN_UBERGRAPH.curie("predicate2"),
    model_uri=SPARQLFUN.predicate2,
    domain=None,
    range=Optional[Union[str, PropertyNodeId]],
)

slots.subject_predicate = Slot(
    uri=SPARQLFUN_UBERGRAPH.subject_predicate,
    name="subject_predicate",
    curie=SPARQLFUN_UBERGRAPH.curie("subject_predicate"),
    model_uri=SPARQLFUN.subject_predicate,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.class_with_constraint = Slot(
    uri=SPARQLFUN_UBERGRAPH.class_with_constraint,
    name="class_with_constraint",
    curie=SPARQLFUN_UBERGRAPH.curie("class_with_constraint"),
    model_uri=SPARQLFUN.class_with_constraint,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.direct_taxon = Slot(
    uri=SPARQLFUN_UBERGRAPH.direct_taxon,
    name="direct_taxon",
    curie=SPARQLFUN_UBERGRAPH.curie("direct_taxon"),
    model_uri=SPARQLFUN.direct_taxon,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.query_has_subclass_ancestor = Slot(
    uri=SPARQLFUN_UBERGRAPH.query_has_subclass_ancestor,
    name="query_has_subclass_ancestor",
    curie=SPARQLFUN_UBERGRAPH.curie("query_has_subclass_ancestor"),
    model_uri=SPARQLFUN.query_has_subclass_ancestor,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.subcategory = Slot(
    uri=SPARQLFUN.subcategory,
    name="subcategory",
    curie=SPARQLFUN.curie("subcategory"),
    model_uri=SPARQLFUN.subcategory,
    domain=None,
    range=Optional[Union[str, ClassNodeId]],
)
...
slots.supplies = Slot(
    uri=RO["0002178"],
    name="supplies",
    curie=RO.curie("0002178"),
    model_uri=SPARQLFUN.supplies,
    domain=None,
...
slots.drains = Slot(
    uri=RO["0002179"],
    name="drains",
    curie=RO.curie("0002179"),
    model_uri=SPARQLFUN.drains,
    domain=None,
    range=Optional[Union[str, AnatomicalEntityId]],
)

slots.branching_part_of = Slot(
    uri=RO["0002380"],
    name="branching_part_of",
    curie=RO.curie("0002380"),
    model_uri=SPARQLFUN.branching_part_of,
    domain=None,
    range=Optional[Union[str, AnatomicalEntityId]],
)

slots.subject_category = Slot(
    uri=SPARQLFUN_BIOLINK.subject_category,
    name="subject_category",
    curie=SPARQLFUN_BIOLINK.curie("subject_category"),
    model_uri=SPARQLFUN.subject_category,
    domain=None,
    range=Optional[Union[str, ClassNodeId]],
)

slots.object_category = Slot(
    uri=SPARQLFUN_BIOLINK.object_category,
    name="object_category",
    curie=SPARQLFUN_BIOLINK.curie("object_category"),
    model_uri=SPARQLFUN.object_category,
    domain=None,
    range=Optional[Union[str, ClassNodeId]],
)

slots.subject_category_inferred = Slot(
    uri=SPARQLFUN_BIOLINK.subject_category_inferred,
    name="subject_category_inferred",
    curie=SPARQLFUN_BIOLINK.curie("subject_category_inferred"),
    model_uri=SPARQLFUN.subject_category_inferred,
    domain=None,
    range=Optional[Union[str, ClassNodeId]],
)

slots.object_category_inferred = Slot(
    uri=SPARQLFUN_BIOLINK.object_category_inferred,
    name="object_category_inferred",
    curie=SPARQLFUN_BIOLINK.curie("object_category_inferred"),
    model_uri=SPARQLFUN.object_category_inferred,
    domain=None,
    range=Optional[Union[str, ClassNodeId]],
)
...
slots.seeAlso = Slot(
    ...
    model_uri=SPARQLFUN.seeAlso,
    domain=None,
    range=Optional[Union[str, ThingId]],
)

slots.objectProperty = Slot(
    uri=UPCORE.objectProperty,
    name="objectProperty",
    curie=UPCORE.curie("objectProperty"),
    model_uri=SPARQLFUN.objectProperty,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.catalyticActivity = Slot(
    uri=UPCORE.catalyticActivity,
    name="catalyticActivity",
    curie=UPCORE.curie("catalyticActivity"),
    model_uri=SPARQLFUN.catalyticActivity,
    domain=None,
    range=Optional[Union[dict, CatalyticActivity]],
)

slots.mappedAnnotation = Slot(
    uri=UPCORE.mappedAnnotation,
    name="mappedAnnotation",
    curie=UPCORE.curie("mappedAnnotation"),
    model_uri=SPARQLFUN.mappedAnnotation,
    domain=None,
    range=Optional[Union[dict, Annotation]],
)

slots.structuredName = Slot(
    uri=UPCORE.structuredName,
    name="structuredName",
    curie=UPCORE.curie("structuredName"),
    model_uri=SPARQLFUN.structuredName,
    domain=None,
    range=Optional[Union[dict, StructuredName]],
)

slots.mappedCitation = Slot(
    uri=UPCORE.mappedCitation,
    name="mappedCitation",
    curie=UPCORE.curie("mappedCitation"),
    model_uri=SPARQLFUN.mappedCitation,
    domain=None,
    range=Optional[Union[str, CitationId]],
)

slots.topology = Slot(
    uri=UPCORE.topology,
    name="topology",
    curie=UPCORE.curie("topology"),
    model_uri=SPARQLFUN.topology,
    domain=None,
    range=Optional[Union[str, TopologyId]],
)

slots.classifiedWith = Slot(
    uri=UPCORE.classifiedWith,
    name="classifiedWith",
    curie=UPCORE.curie("classifiedWith"),
    model_uri=SPARQLFUN.classifiedWith,
    domain=None,
    range=Optional[Union[str, ConceptId]],
)

slots.encodedIn = Slot(
    uri=UPCORE.encodedIn,
    name="encodedIn",
    curie=UPCORE.curie("encodedIn"),
    model_uri=SPARQLFUN.encodedIn,
    domain=None,
    range=Optional[Union[str, SubcellularLocationId]],
)

slots.potentialSequence = Slot(
    uri=UPCORE.potentialSequence,
    name="potentialSequence",
    curie=UPCORE.curie("potentialSequence"),
    model_uri=SPARQLFUN.potentialSequence,
    domain=None,
    range=Optional[Union[dict, Sequence]],
)

slots.domain = Slot(
    uri=UPCORE.domain,
    name="domain",
    curie=UPCORE.curie("domain"),
    model_uri=SPARQLFUN.domain,
    domain=None,
    range=Optional[Union[str, PartId]],
)

slots.enzymeClass = Slot(
    uri=UPCORE.enzymeClass,
    name="enzymeClass",
    curie=UPCORE.curie("enzymeClass"),
    model_uri=SPARQLFUN.enzymeClass,
    domain=None,
    range=Optional[Union[str, EnzymeId]],
)

slots.publishedIn = Slot(
    uri=UPCORE.publishedIn,
    name="publishedIn",
    curie=UPCORE.curie("publishedIn"),
    model_uri=SPARQLFUN.publishedIn,
    domain=None,
    range=Optional[Union[str, JournalId]],
)

slots.translatedFrom = Slot(
    uri=UPCORE.translatedFrom,
    name="translatedFrom",
    curie=UPCORE.curie("translatedFrom"),
    model_uri=SPARQLFUN.translatedFrom,
    domain=None,
    range=Optional[Union[dict, NucleotideResource]],
)

slots.erratumFor = Slot(
    uri=UPCORE.erratumFor,
    name="erratumFor",
    curie=UPCORE.curie("erratumFor"),
    model_uri=SPARQLFUN.erratumFor,
    domain=None,
    range=Optional[Union[str, PublishedCitationId]],
)

slots.member = Slot(
    uri=UPCORE.member,
    name="member",
    curie=UPCORE.curie("member"),
    model_uri=SPARQLFUN.member,
    domain=None,
    range=Optional[Union[dict, Sequence]],
)

slots.interaction = Slot(
    uri=UPCORE.interaction,
    name="interaction",
    curie=UPCORE.curie("interaction"),
    model_uri=SPARQLFUN.interaction,
    domain=None,
    range=Optional[Union[dict, Interaction]],
)

slots.attribution = Slot(
    uri=UPCORE.attribution,
    name="attribution",
    curie=UPCORE.curie("attribution"),
    model_uri=SPARQLFUN.attribution,
    domain=None,
    range=Optional[Union[dict, Attribution]],
)

slots.erratum = Slot(
    uri=UPCORE.erratum,
    name="erratum",
    curie=UPCORE.curie("erratum"),
    model_uri=SPARQLFUN.erratum,
    domain=None,
    range=Optional[Union[str, PublishedCitationId]],
)
...
slots.strain = Slot(
    uri=UPCORE.strain,
    name="strain",
    curie=UPCORE.curie("strain"),
    model_uri=SPARQLFUN.strain,
    domain=None,
    range=Optional[Union[dict, Strain]],
)

slots.basedOn = Slot(
    uri=UPCORE.basedOn,
    name="basedOn",
    curie=UPCORE.curie("basedOn"),
    model_uri=SPARQLFUN.basedOn,
    domain=None,
    range=Optional[Union[dict, SimpleSequence]],
)

slots.alternativeName = Slot(
    uri=UPCORE.alternativeName,
    name="alternativeName",
    curie=UPCORE.curie("alternativeName"),
    model_uri=SPARQLFUN.alternativeName,
    domain=None,
    range=Optional[Union[dict, StructuredName]],
)

slots.orientation = Slot(
    uri=UPCORE.orientation,
    name="orientation",
    curie=UPCORE.curie("orientation"),
    model_uri=SPARQLFUN.orientation,
    domain=None,
    range=Optional[Union[str, OrientationId]],
)

slots.database = Slot(
    uri=UPCORE.database,
    name="database",
    curie=UPCORE.curie("database"),
    model_uri=SPARQLFUN.database,
    domain=None,
    range=Optional[Union[str, DatabaseId]],
)

slots.host = Slot(
    uri=UPCORE.host,
    name="host",
    curie=UPCORE.curie("host"),
    model_uri=SPARQLFUN.host,
    domain=None,
    range=Optional[Union[str, TaxonId]],
)

slots.enzyme = Slot(
    uri=UPCORE.enzyme,
    name="enzyme",
    curie=UPCORE.curie("enzyme"),
    model_uri=SPARQLFUN.enzyme,
    domain=None,
    range=Optional[Union[str, EnzymeId]],
)

slots.modification = Slot(
    uri=UPCORE.modification,
    name="modification",
    curie=UPCORE.curie("modification"),
    model_uri=SPARQLFUN.modification,
    domain=None,
    range=Optional[Union[dict, AlternativeSequenceAnnotation]],
)

slots.partOf = Slot(
    uri=UPCORE.partOf,
    name="partOf",
    curie=UPCORE.curie("partOf"),
    model_uri=SPARQLFUN.partOf,
    domain=None,
    range=Optional[Union[str, SubcellularLocationId]],
)
...
slots.rank = Slot(
    uri=UPCORE.rank,
    name="rank",
    curie=UPCORE.curie("rank"),
    model_uri=SPARQLFUN.rank,
    domain=None,
    range=Optional[Union[dict, Rank]],
)

slots.participant = Slot(
    uri=UPCORE.participant,
    name="participant",
    curie=UPCORE.curie("participant"),
    model_uri=SPARQLFUN.participant,
    domain=None,
    range=Optional[Union[dict, Participant]],
)

slots.activity = Slot(
    uri=UPCORE.activity,
    name="activity",
    curie=UPCORE.curie("activity"),
    model_uri=SPARQLFUN.activity,
    domain=None,
    range=Optional[Union[dict, CatalyticActivity]],
)
...
slots.organism = Slot(
    uri=UPCORE.organism,
    name="organism",
    curie=UPCORE.curie("organism"),
    model_uri=SPARQLFUN.organism,
    domain=None,
    range=Optional[Union[str, TaxonId]],
)

slots.conflictingSequence = Slot(
    uri=UPCORE.conflictingSequence,
    name="conflictingSequence",
    curie=UPCORE.curie("conflictingSequence"),
    model_uri=SPARQLFUN.conflictingSequence,
    domain=None,
    range=Optional[Union[dict, ExternalSequence]],
)

slots.citation = Slot(
    uri=UPCORE.citation,
    name="citation",
    curie=UPCORE.curie("citation"),
    model_uri=SPARQLFUN.citation,
    domain=None,
    range=Optional[Union[str, CitationId]],
)
...
slots.seedFor = Slot(
    uri=UPCORE.seedFor,
    name="seedFor",
    curie=UPCORE.curie("seedFor"),
    model_uri=SPARQLFUN.seedFor,
    domain=None,
    range=Optional[Union[str, ClusterId]],
)

slots.representativeFor = Slot(
    uri=UPCORE.representativeFor,
    name="representativeFor",
    curie=UPCORE.curie("representativeFor"),
    model_uri=SPARQLFUN.representativeFor,
    domain=None,
    range=Optional[Union[str, ClusterId]],
)

slots.relatedLocation = Slot(
    uri=UPCORE.relatedLocation,
    name="relatedLocation",
    curie=UPCORE.curie("relatedLocation"),
    model_uri=SPARQLFUN.relatedLocation,
    domain=None,
    range=Optional[Union[str, SubcellularLocationId]],
)

slots.isolatedFrom = Slot(
    uri=UPCORE.isolatedFrom,
    name="isolatedFrom",
    curie=UPCORE.curie("isolatedFrom"),
    model_uri=SPARQLFUN.isolatedFrom,
    domain=None,
    range=Optional[Union[dict, Tissue]],
)

slots.component = Slot(
    uri=UPCORE.component,
    name="component",
    curie=UPCORE.curie("component"),
    model_uri=SPARQLFUN.component,
    domain=None,
    range=Optional[Union[str, PartId]],
)

slots.annotation = Slot(
    uri=UPCORE.annotation,
    name="annotation",
    curie=UPCORE.curie("annotation"),
    model_uri=SPARQLFUN.annotation,
    domain=None,
    range=Optional[Union[dict, Annotation]],
)

slots.commonTaxon = Slot(
    uri=UPCORE.commonTaxon,
    name="commonTaxon",
    curie=UPCORE.curie("commonTaxon"),
    model_uri=SPARQLFUN.commonTaxon,
    domain=None,
    range=Optional[Union[str, TaxonId]],
)

slots.encodedBy = Slot(
    uri=UPCORE.encodedBy,
    name="encodedBy",
    curie=UPCORE.curie("encodedBy"),
    model_uri=SPARQLFUN.encodedBy,
    domain=None,
    range=Optional[Union[str, GeneId]],
)

slots.disease = Slot(
    uri=UPCORE.disease,
    name="disease",
    curie=UPCORE.curie("disease"),
    model_uri=SPARQLFUN.disease,
    domain=None,
...
slots.sequence = Slot(
    uri=UPCORE.sequence,
    name="sequence",
    curie=UPCORE.curie("sequence"),
    model_uri=SPARQLFUN.sequence,
    domain=None,
    range=Optional[Union[dict, Sequence]],
)
...
slots.part = Slot(
    uri=UPCORE.part,
    name="part",
    curie=UPCORE.curie("part"),
    model_uri=SPARQLFUN.part,
    domain=None,
    range=Optional[Union[str, PartId]],
)

slots.submittedName = Slot(
    uri=UPCORE.submittedName,
    name="submittedName",
    curie=UPCORE.curie("submittedName"),
    model_uri=SPARQLFUN.submittedName,
    domain=None,
    range=Optional[Union[dict, StructuredName]],
)

slots.redundantTo = Slot(
    uri=UPCORE.redundantTo,
    name="redundantTo",
    curie=UPCORE.curie("redundantTo"),
    model_uri=SPARQLFUN.redundantTo,
    domain=None,
    range=Optional[Union[dict, Proteome]],
)

slots.locatedOn = Slot(
    uri=UPCORE.locatedOn,
    name="locatedOn",
    curie=UPCORE.curie("locatedOn"),
    model_uri=SPARQLFUN.locatedOn,
    domain=None,
    range=Optional[Union[dict, Molecule]],
)

slots.recommendedName = Slot(
    uri=UPCORE.recommendedName,
    name="recommendedName",
    curie=UPCORE.curie("recommendedName"),
    model_uri=SPARQLFUN.recommendedName,
    domain=None,
    range=Optional[Union[dict, StructuredName]],
)

slots.cellularComponent = Slot(
    uri=UPCORE.cellularComponent,
    name="cellularComponent",
    curie=UPCORE.curie("cellularComponent"),
    model_uri=SPARQLFUN.cellularComponent,
    domain=None,
    range=Optional[Union[str, CellularComponentId]],
)

slots.memberOf = Slot(
    uri=UPCORE.memberOf,
    name="memberOf",
    curie=UPCORE.curie("memberOf"),
    model_uri=SPARQLFUN.memberOf,
    domain=None,
    range=Optional[Union[str, ClusterId]],
)

slots.panproteome = Slot(
    uri=UPCORE.panproteome,
    name="panproteome",
    curie=UPCORE.curie("panproteome"),
    model_uri=SPARQLFUN.panproteome,
    domain=None,
    range=Optional[Union[dict, Proteome]],
)

slots.nucleotideSequenceMappingIssue = Slot(
    uri=UPCORE.nucleotideSequenceMappingIssue,
    name="nucleotideSequenceMappingIssue",
    curie=UPCORE.curie("nucleotideSequenceMappingIssue"),
    model_uri=SPARQLFUN.nucleotideSequenceMappingIssue,
    domain=None,
    range=Optional[Union[dict, NucleotideResource]],
)
...
slots.method = Slot(
    uri=UPCORE.method,
    name="method",
    curie=UPCORE.curie("method"),
    model_uri=SPARQLFUN.method,
    domain=None,
    range=Optional[Union[dict, Method]],
)

slots.datatypeProperty = Slot(
    uri=UPCORE.datatypeProperty,
    name="datatypeProperty",
    curie=UPCORE.curie("datatypeProperty"),
    model_uri=SPARQLFUN.datatypeProperty,
    domain=None,
    range=Optional[Union[str, NodeId]],
)
...
slots.title = Slot(
    uri=UPCORE.title,
    name="title",
    curie=UPCORE.curie("title"),
    model_uri=SPARQLFUN.title,
    domain=None,
    range=Optional[str],
)
...
slots.height = Slot(
    uri=UPCORE.height,
    name="height",
    curie=UPCORE.curie("height"),
    model_uri=SPARQLFUN.height,
    domain=None,
    range=Optional[int],
)

slots.cofactorLabel = Slot(
    uri=UPCORE.cofactorLabel,
    name="cofactorLabel",
    curie=UPCORE.curie("cofactorLabel"),
    model_uri=SPARQLFUN.cofactorLabel,
    domain=None,
    range=Optional[str],
)

slots.precursor = Slot(
    uri=UPCORE.precursor,
    name="precursor",
    curie=UPCORE.curie("precursor"),
    model_uri=SPARQLFUN.precursor,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
...
slots.created = Slot(
    uri=UPCORE.created,
    name="created",
    curie=UPCORE.curie("created"),
    model_uri=SPARQLFUN.created,
    domain=None,
    range=Optional[Union[str, XSDDate]],
)

slots.linkIsExplicit = Slot(
    uri=UPCORE.linkIsExplicit,
    name="linkIsExplicit",
    curie=UPCORE.curie("linkIsExplicit"),
    model_uri=SPARQLFUN.linkIsExplicit,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
...
slots.length = Slot(
    uri=UPCORE.length,
    name="length",
    curie=UPCORE.curie("length"),
    model_uri=SPARQLFUN.length,
    domain=None,
    range=Optional[int],
)

slots.partOfLineage = Slot(
    uri=UPCORE.partOfLineage,
    name="partOfLineage",
    curie=UPCORE.curie("partOfLineage"),
    model_uri=SPARQLFUN.partOfLineage,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.measuredActivity = Slot(
    uri=UPCORE.measuredActivity,
    name="measuredActivity",
    curie=UPCORE.curie("measuredActivity"),
    model_uri=SPARQLFUN.measuredActivity,
    domain=None,
    range=Optional[str],
)
...
slots.curated = Slot(
    uri=UPCORE.curated,
    name="curated",
    curie=UPCORE.curie("curated"),
    model_uri=SPARQLFUN.curated,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.otherName = Slot(
    uri=UPCORE.otherName,
    name="otherName",
    curie=UPCORE.curie("otherName"),
    model_uri=SPARQLFUN.otherName,
    domain=None,
    range=Optional[str],
)

slots.experiments = Slot(
    uri=UPCORE.experiments,
    name="experiments",
    curie=UPCORE.curie("experiments"),
    model_uri=SPARQLFUN.experiments,
    domain=None,
    range=Optional[int],
)
...
slots.reviewed = Slot(
    uri=UPCORE.reviewed,
    name="reviewed",
    curie=UPCORE.curie("reviewed"),
    model_uri=SPARQLFUN.reviewed,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
...
slots.modified = Slot(
    uri=UPCORE.modified,
    name="modified",
    curie=UPCORE.curie("modified"),
    model_uri=SPARQLFUN.modified,
    domain=None,
    range=Optional[Union[str, XSDDate]],
)

slots.institution = Slot(
    uri=UPCORE.institution,
    name="institution",
    curie=UPCORE.curie("institution"),
    model_uri=SPARQLFUN.institution,
    domain=None,
    range=Optional[str],
)

slots.authorsIncomplete = Slot(
    uri=UPCORE.authorsIncomplete,
    name="authorsIncomplete",
    curie=UPCORE.curie("authorsIncomplete"),
    model_uri=SPARQLFUN.authorsIncomplete,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
...
slots.abstract = Slot(
    uri=UPCORE.abstract,
    name="abstract",
    curie=UPCORE.curie("abstract"),
    model_uri=SPARQLFUN.abstract,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.groupcore = Slot(
    uri=UPCORE.group,
    name="groupcore",
    curie=UPCORE.curie("group"),
    model_uri=SPARQLFUN.groupcore,
    domain=None,
    range=Optional[str],
)
...
slots.orfName = Slot(
    uri=UPCORE.orfName,
    name="orfName",
    curie=UPCORE.curie("orfName"),
    model_uri=SPARQLFUN.orfName,
    domain=None,
    range=Optional[str],
)
...
slots.width = Slot(
    uri=UPCORE.width,
    name="width",
    curie=UPCORE.curie("width"),
    model_uri=SPARQLFUN.width,
    domain=None,
    range=Optional[int],
)
...
slots.place = Slot(
    uri=UPCORE.place,
    name="place",
    curie=UPCORE.curie("place"),
    model_uri=SPARQLFUN.place,
    domain=None,
    range=Optional[str],
)
...
slots.name = Slot(
    uri=UPCORE.name,
    name="name",
    curie=UPCORE.curie("name"),
    model_uri=SPARQLFUN.name,
    domain=None,
    range=Optional[str],
)

slots.md5Checksum = Slot(
    uri=UPCORE.md5Checksum,
    name="md5Checksum",
    curie=UPCORE.curie("md5Checksum"),
    model_uri=SPARQLFUN.md5Checksum,
    domain=None,
    range=Optional[str],
)
...
slots.mnemonic = Slot(
    uri=UPCORE.mnemonic,
    name="mnemonic",
    curie=UPCORE.curie("mnemonic"),
    model_uri=SPARQLFUN.mnemonic,
    domain=None,
    range=Optional[str],
)

slots.frameshift = Slot(
    uri=UPCORE.frameshift,
    name="frameshift",
    curie=UPCORE.curie("frameshift"),
    model_uri=SPARQLFUN.frameshift,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.oldMnemonic = Slot(
    uri=UPCORE.oldMnemonic,
    name="oldMnemonic",
    curie=UPCORE.curie("oldMnemonic"),
    model_uri=SPARQLFUN.oldMnemonic,
    domain=None,
    range=Optional[str],
)
...
slots.chain = Slot(
    uri=UPCORE.chain,
    name="chain",
    curie=UPCORE.curie("chain"),
    model_uri=SPARQLFUN.chain,
    domain=None,
    range=Optional[str],
)
...
slots.pages = Slot(
    uri=UPCORE.pages,
    name="pages",
    curie=UPCORE.curie("pages"),
    model_uri=SPARQLFUN.pages,
    domain=None,
    range=Optional[str],
)
...
slots.pattern = Slot(
    uri=UPCORE.pattern,
    name="pattern",
    curie=UPCORE.curie("pattern"),
    model_uri=SPARQLFUN.pattern,
    domain=None,
    range=Optional[str],
)

slots.substitution = Slot(
    uri=UPCORE.substitution,
    name="substitution",
    curie=UPCORE.curie("substitution"),
    model_uri=SPARQLFUN.substitution,
    domain=None,
    range=Optional[str],
)
...
slots.version = Slot(
    uri=UPCORE.version,
    name="version",
    curie=UPCORE.curie("version"),
    model_uri=SPARQLFUN.version,
    domain=None,
    range=Optional[int],
)
...
slots.implicit = Slot(
    uri=UPCORE.implicit,
    name="implicit",
    curie=UPCORE.curie("implicit"),
    model_uri=SPARQLFUN.implicit,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.measuredAffinity = Slot(
    uri=UPCORE.measuredAffinity,
    name="measuredAffinity",
    curie=UPCORE.curie("measuredAffinity"),
    model_uri=SPARQLFUN.measuredAffinity,
    domain=None,
    range=Optional[str],
)
...
slots.obsolete = Slot(
    uri=UPCORE.obsolete,
    name="obsolete",
    curie=UPCORE.curie("obsolete"),
    model_uri=SPARQLFUN.obsolete,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
...
slots.locator = Slot(
    uri=UPCORE.locator,
    name="locator",
    curie=UPCORE.curie("locator"),
    model_uri=SPARQLFUN.locator,
    domain=None,
    range=Optional[str],
)
...
slots.mass = Slot(
    uri=UPCORE.mass,
    name="mass",
    curie=UPCORE.curie("mass"),
    model_uri=SPARQLFUN.mass,
    domain=None,
    range=Optional[int],
)

slots.uriTemplate = Slot(
    uri=UPCORE.uriTemplate,
    name="uriTemplate",
    curie=UPCORE.curie("uriTemplate"),
    model_uri=SPARQLFUN.uriTemplate,
    domain=None,
    range=Optional[str],
)

slots.scientificName = Slot(
    uri=UPCORE.scientificName,
    name="scientificName",
    curie=UPCORE.curie("scientificName"),
    model_uri=SPARQLFUN.scientificName,
    domain=None,
    range=Optional[str],
)
...
slots.alias = Slot(
    uri=UPCORE.alias,
    name="alias",
    curie=UPCORE.curie("alias"),
    model_uri=SPARQLFUN.alias,
    domain=None,
    range=Optional[str],
)

slots.exclusionReason = Slot(
    uri=UPCORE.exclusionReason,
    name="exclusionReason",
    curie=UPCORE.curie("exclusionReason"),
    model_uri=SPARQLFUN.exclusionReason,
    domain=None,
    range=Optional[str],
)

slots.measuredError = Slot(
    uri=UPCORE.measuredError,
    name="measuredError",
    curie=UPCORE.curie("measuredError"),
    model_uri=SPARQLFUN.measuredError,
    domain=None,
    range=Optional[float],
)

slots.publisher = Slot(
    uri=UPCORE.publisher,
    name="publisher",
    curie=UPCORE.curie("publisher"),
    model_uri=SPARQLFUN.publisher,
    domain=None,
    range=Optional[str],
)
...
slots.maximum = Slot(
    uri=UPCORE.maximum,
    name="maximum",
    curie=UPCORE.curie("maximum"),
    model_uri=SPARQLFUN.maximum,
    domain=None,
    range=Optional[float],
)

slots.structuredNameType = Slot(
    uri=UPCORE.structuredNameType,
    name="structuredNameType",
    curie=UPCORE.curie("structuredNameType"),
    model_uri=SPARQLFUN.structuredNameType,
    domain=None,
    range=Optional[str],
)
...
slots.editor = Slot(
    uri=UPCORE.editor,
    name="editor",
    curie=UPCORE.curie("editor"),
    model_uri=SPARQLFUN.editor,
    domain=None,
    range=Optional[str],
)
...
slots.author = Slot(
    uri=UPCORE.author,
    name="author",
    curie=UPCORE.curie("author"),
    model_uri=SPARQLFUN.author,
    domain=None,
    range=Optional[str],
)

slots.measuredValue = Slot(
    uri=UPCORE.measuredValue,
    name="measuredValue",
    curie=UPCORE.curie("measuredValue"),
    model_uri=SPARQLFUN.measuredValue,
    domain=None,
    range=Optional[float],
)
...
slots.negative = Slot(
    uri=UPCORE.negative,
    name="negative",
    curie=UPCORE.curie("negative"),
    model_uri=SPARQLFUN.negative,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.shortCoden = Slot(
    uri=UPCORE.shortCoden,
    name="shortCoden",
    curie=UPCORE.curie("shortCoden"),
    model_uri=SPARQLFUN.shortCoden,
    domain=None,
    range=Optional[str],
)
...
slots.xeno = Slot(
    uri=UPCORE.xeno,
    name="xeno",
    curie=UPCORE.curie("xeno"),
    model_uri=SPARQLFUN.xeno,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
...
slots.synonym = Slot(
    uri=UPCORE.synonym,
    name="synonym",
    curie=UPCORE.curie("synonym"),
    model_uri=SPARQLFUN.synonym,
    domain=None,
    range=Optional[str],
)
...
slots.scope = Slot(
    uri=UPCORE.scope,
    name="scope",
    curie=UPCORE.curie("scope"),
    model_uri=SPARQLFUN.scope,
    domain=None,
    range=Optional[str],
)

slots.urlTemplate = Slot(
    uri=UPCORE.urlTemplate,
    name="urlTemplate",
    curie=UPCORE.curie("urlTemplate"),
    model_uri=SPARQLFUN.urlTemplate,
    domain=None,
    range=Optional[str],
)

slots.resolution = Slot(
    uri=UPCORE.resolution,
    name="resolution",
    curie=UPCORE.curie("resolution"),
    model_uri=SPARQLFUN.resolution,
    domain=None,
    range=Optional[float],
)
...
slots.manual = Slot(
    uri=UPCORE.manual,
    name="manual",
    curie=UPCORE.curie("manual"),
    model_uri=SPARQLFUN.manual,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
...
slots.certain = Slot(
    uri=UPCORE.certain,
    name="certain",
    curie=UPCORE.curie("certain"),
    model_uri=SPARQLFUN.certain,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
...
slots.complete = Slot(
    uri=UPCORE.complete,
    name="complete",
    curie=UPCORE.curie("complete"),
    model_uri=SPARQLFUN.complete,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.nestedTriple__xobject = Slot(
    uri=RDF.xobject,
    name="nestedTriple__xobject",
    curie=RDF.curie("xobject"),
    model_uri=SPARQLFUN.nestedTriple__xobject,
    domain=None,
    range=Optional[Union[str, NodeId]],
)

slots.basicClass__subClassOf = Slot(
    uri=RDFS.subClassOf,
    name="basicClass__subClassOf",
    curie=RDFS.curie("subClassOf"),
    model_uri=SPARQLFUN.basicClass__subClassOf,
    domain=None,
    range=Optional[Union[Union[str, ClassNodeId], List[Union[str, ClassNodeId]]]],
)

slots.statement_node_statements = Slot(
    uri=SPARQLFUN.node_statements,
    name="statement_node_statements",
    curie=SPARQLFUN.curie("node_statements"),
    model_uri=SPARQLFUN.statement_node_statements,
    domain=Statement,
    range=Optional[
        Union[
            Union[dict, "NodeToNodeStatement"], List[Union[dict, "NodeToNodeStatement"]]
...
slots.statement_value_statements = Slot(
    uri=SPARQLFUN.value_statements,
    name="statement_value_statements",
    curie=SPARQLFUN.curie("value_statements"),
    model_uri=SPARQLFUN.statement_value_statements,
    domain=Statement,
    range=Optional[
        Union[
            Union[dict, "NodeToValueStatement"],
...
slots.node_to_node_triple_object = Slot(
    uri=RDF.object,
    name="node to node triple_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.node_to_node_triple_object,
    domain=NodeToNodeTriple,
    range=Optional[Union[str, NodeId]],
)

slots.node_to_node_statement_object = Slot(
    uri=RDF.object,
    name="node to node statement_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.node_to_node_statement_object,
    domain=NodeToNodeStatement,
    range=Optional[Union[str, NodeId]],
)

slots.node_to_value_triple_object = Slot(
    uri=RDF.object,
    name="node to value triple_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.node_to_value_triple_object,
    domain=NodeToValueTriple,
    range=Optional[str],
)

slots.node_to_value_statement_object = Slot(
    uri=RDF.object,
    name="node to value statement_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.node_to_value_statement_object,
    domain=NodeToValueStatement,
    range=Optional[str],
)

slots.rdf_type_triple_object = Slot(
    uri=RDF.object,
    name="rdf type triple_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.rdf_type_triple_object,
    domain=RdfTypeTriple,
    range=Optional[Union[str, ClassNodeId]],
)

slots.rdf_type_statement_object = Slot(
    uri=RDF.object,
    name="rdf type statement_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.rdf_type_statement_object,
    domain=RdfTypeStatement,
    range=Optional[Union[str, ClassNodeId]],
)

slots.rdfs_subclass_of_triple_subject = Slot(
    uri=RDF.subject,
    name="rdfs subclass of triple_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.rdfs_subclass_of_triple_subject,
    domain=RdfsSubclassOfTriple,
    range=Optional[Union[str, ClassNodeId]],
)

slots.rdfs_subclass_of_triple_object = Slot(
    uri=RDF.object,
    name="rdfs subclass of triple_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.rdfs_subclass_of_triple_object,
    domain=RdfsSubclassOfTriple,
    range=Optional[Union[str, ClassNodeId]],
)

slots.rdfs_subproperty_of_triple_subject = Slot(
    uri=RDF.subject,
    name="rdfs subproperty of triple_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.rdfs_subproperty_of_triple_subject,
    domain=RdfsSubpropertyOfTriple,
    range=Optional[Union[str, PropertyNodeId]],
)

slots.rdfs_subproperty_of_triple_object = Slot(
    uri=RDF.object,
    name="rdfs subproperty of triple_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.rdfs_subproperty_of_triple_object,
    domain=RdfsSubpropertyOfTriple,
    range=Optional[Union[str, PropertyNodeId]],
)

slots.rdfs_label_triple_value = Slot(
    uri=SPARQLFUN_RDF.value,
    name="rdfs label triple_value",
    curie=SPARQLFUN_RDF.curie("value"),
    model_uri=SPARQLFUN.rdfs_label_triple_value,
    domain=RdfsLabelTriple,
    range=Optional[str],
)

slots.iri_node_id = Slot(
    uri=SPARQLFUN_RDF.id,
    name="iri node_id",
    curie=SPARQLFUN_RDF.curie("id"),
    model_uri=SPARQLFUN.iri_node_id,
    domain=IriNode,
    range=Union[str, IriNodeId],
    pattern=re.compile(r"^_:"),
)

slots.nested_triple_subject = Slot(
    uri=RDF.subject,
    name="nested triple_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.nested_triple_subject,
    domain=NestedTriple,
    range=Optional[Union[str, NodeId]],
)

slots.nested_triple_object = Slot(
    uri=RDF.object,
    name="nested triple_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.nested_triple_object,
    domain=NestedTriple,
    range=Optional[Union[str, NodeId]],
)

slots.equivalence_triple_mixin_subject = Slot(
    uri=RDF.subject,
    name="equivalence triple mixin_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.equivalence_triple_mixin_subject,
    domain=None,
    range=Optional[Union[str, ClassNodeId]],
)

slots.equivalence_triple_mixin_object = Slot(
    uri=RDF.object,
    name="equivalence triple mixin_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.equivalence_triple_mixin_object,
    domain=None,
    range=Optional[Union[str, ClassNodeId]],
)

slots.owl_named_equivalent_class_triple_subject = Slot(
    uri=RDF.subject,
    name="owl named equivalent class triple_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.owl_named_equivalent_class_triple_subject,
    domain=OwlNamedEquivalentClassTriple,
    range=Optional[Union[str, ClassNodeId]],
)

slots.owl_named_equivalent_class_triple_object = Slot(
    uri=RDF.object,
    name="owl named equivalent class triple_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.owl_named_equivalent_class_triple_object,
    domain=OwlNamedEquivalentClassTriple,
    range=Optional[Union[str, ClassNodeId]],
)

slots.describe_equivalent_expression_results = Slot(
    uri=RESULTSET.results,
    name="describe equivalent expression_results",
    curie=RESULTSET.curie("results"),
    model_uri=SPARQLFUN.describe_equivalent_expression_results,
    domain=DescribeEquivalentExpression,
    range=Optional[Union[Union[str, ClassNodeId], List[Union[str, ClassNodeId]]]],
)

slots.relation_graph_quad_graph = Slot(
    uri=RDFS.isDefinedBy,
    name="relation graph quad_graph",
    curie=RDFS.curie("isDefinedBy"),
    model_uri=SPARQLFUN.relation_graph_quad_graph,
    domain=RelationGraphQuad,
    range=Optional[Union[str, NodeId]],
)

slots.non_redundant_quad_graph = Slot(
    uri=RDFS.isDefinedBy,
    name="non redundant quad_graph",
    curie=RDFS.curie("isDefinedBy"),
    model_uri=SPARQLFUN.non_redundant_quad_graph,
    domain=NonRedundantQuad,
    range=Optional[Union[str, ClassNodeId]],
)

slots.taxon_applicable_subject = Slot(
    uri=RDF.subject,
    name="taxon applicable_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.taxon_applicable_subject,
    domain=None,
    range=Optional[Union[str, TaxonApplicableClassId]],
)

slots.taxon_applicable_object = Slot(
    uri=RDF.object,
    name="taxon applicable_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.taxon_applicable_object,
    domain=None,
    range=Optional[Union[str, TaxonClassId]],
)

slots.obo_class_query_results = Slot(
    uri=RESULTSET.results,
    name="obo class query_results",
    curie=RESULTSET.curie("results"),
    model_uri=SPARQLFUN.obo_class_query_results,
    domain=OboClassQuery,
    range=Optional[Union[Union[str, OboClassId], List[Union[str, OboClassId]]]],
)

slots.deprecated_obo_class_query_results = Slot(
    uri=RESULTSET.results,
    name="deprecated obo class query_results",
    curie=RESULTSET.curie("results"),
    model_uri=SPARQLFUN.deprecated_obo_class_query_results,
    domain=DeprecatedOboClassQuery,
    range=Optional[Union[Union[str, OboClassId], List[Union[str, OboClassId]]]],
)

slots.class_taxon_exclusion_via_never_in_subject = Slot(
    uri=RDF.subject,
    name="class taxon exclusion via never in_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.class_taxon_exclusion_via_never_in_subject,
    domain=ClassTaxonExclusionViaNeverIn,
    range=Optional[Union[str, NodeId]],
)

slots.class_taxon_exclusion_via_never_in_object = Slot(
    uri=RDF.object,
    name="class taxon exclusion via never in_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.class_taxon_exclusion_via_never_in_object,
    domain=ClassTaxonExclusionViaNeverIn,
    range=Optional[Union[dict, NodeOrLiteral]],
)

slots.class_taxon_exclusion_via_only_in_subject = Slot(
    uri=RDF.subject,
    name="class taxon exclusion via only in_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.class_taxon_exclusion_via_only_in_subject,
    domain=ClassTaxonExclusionViaOnlyIn,
    range=Optional[Union[str, NodeId]],
)

slots.class_taxon_exclusion_via_only_in_object = Slot(
    uri=RDF.object,
    name="class taxon exclusion via only in_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.class_taxon_exclusion_via_only_in_object,
    domain=ClassTaxonExclusionViaOnlyIn,
    range=Optional[Union[dict, NodeOrLiteral]],
)

slots.class_taxon_exclusion_subject = Slot(
    uri=RDF.subject,
    name="class taxon exclusion_subject",
    curie=RDF.curie("subject"),
    model_uri=SPARQLFUN.class_taxon_exclusion_subject,
    domain=ClassTaxonExclusion,
    range=Optional[Union[str, NodeId]],
)

slots.class_taxon_exclusion_object = Slot(
    uri=RDF.object,
    name="class taxon exclusion_object",
    curie=RDF.curie("object"),
    model_uri=SPARQLFUN.class_taxon_exclusion_object,
    domain=ClassTaxonExclusion,
    range=Optional[Union[dict, NodeOrLiteral]],
)

slots.blood_vessel_subcategory = Slot(
    uri=SPARQLFUN.subcategory,
    name="blood vessel_subcategory",
    curie=SPARQLFUN.curie("subcategory"),
    model_uri=SPARQLFUN.blood_vessel_subcategory,
    domain=BloodVessel,
    range=Optional[Union[str, "BloodVesselSubcategory"]],
)
